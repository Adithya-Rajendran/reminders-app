...
export const WIDGET_MANIFEST = [
  ...
  { type: 'daily',     label: 'Daily Plan',    desc: 'Pick 1–3 things for today; shut down at night', plugs: ['tasks', 'projects'], requires: ['caldav'], defaultSize: { w: 10, h: 11 }, minSize: { w: 6, h: 6 }, maxSize: { w: 18, h: 24 }, aspect: { min: 0.45, max: 1.05 } }, // plan/shutdown lists stack — portrait-leaning
  { type: 'focus',     label: 'Focus',         desc: 'One task and a timer — nothing else', plugs: ['tasks', 'reminder-events'], requires: ['caldav'], defaultSize: { w: 7, h: 8 }, minSize: { w: 4, h: 5 }, maxSize: { w: 12, h: 20 }, aspect: { min: 0.55, max: 1.0 } }, // a single-task column stays tall & narrow
]
