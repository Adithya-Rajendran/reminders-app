...
export const WIDGET_MANIFEST = [
  ...
  { type: 'reminders', label: 'Reminders',     desc: 'Actionable task list — snooze, schedule, complete', plugs: ['tasks', 'reminder-events', 'projects', 'reminder-groups', 'organizer'], requires: ['caldav'], pickGroup: true, minSize: { w: 5, h: 5 }, maxSize: { w: 26, h: 28 }, aspect: { min: 0.55, max: 1.45 },
  ...
  { type: 'upcoming',  label: 'Upcoming',      desc: 'Dated tasks grouped by Today / Tomorrow / This week', plugs: ['tasks', 'projects', 'organizer'], requires: ['caldav'], minSize: { w: 5, h: 5 }, maxSize: { w: 26, h: 28 }, aspect: { min: 0.55, max: 1.45 },
  ...
  { type: 'notepin',   label: 'Note',          desc: 'Pin one note to your board — read it right beside your tasks', plugs: ['notes'], requires: ['nextcloud'], defaultSize: { w: 8, h: 8 }, minSize: { w: 4, h: 4 }, maxSize: { w: 20, h: 20 }, aspect: { min: 0.5, max: 1.8 } }, // a sticky-note surface — square-ish to portrait
  { type: 'review',    label: 'Weekly Review', desc: 'Completions, multi-week trend, and a guided weekly review', plugs: ['tasks', 'organizer'], requires: ['caldav'], defaultSize: { w: 9, h: 7 }, minSize: { w: 6, h: 5 }, maxSize: { w: 18, h: 12 }, aspect: { min: 0.7, max: 1.85 },
    mcp: { summary: 'Read completion stats and multi-week trends', tools: ['review_stats'] } }, // compact stats card — wide, not a tall sliver
  ...
  { type: 'triage',    label: 'Prioritize',    desc: 'Sort what matters: the Eisenhower matrix + your most important task', plugs: ['tasks', 'organizer'], requires: ['caldav'], defaultSize: { w: 10, h: 12 }, minSize: { w: 6, h: 8 }, maxSize: { w: 18, h: 26 }, aspect: { min: 0.45, max: 1.05 },
    mcp: { summary: 'Read the prioritization queue / Eisenhower matrix and set a task’s importance + urgency', tools: ['triage_queue', 'triage_matrix', 'triage_set'] } }, // matrix + most-important callout + queue — portrait-leaning
