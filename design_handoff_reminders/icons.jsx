/* ============================================================
   ...
   ============================================================ */
const Icon = ({ d, size = 18, sw = 1.75, fill, children, label, ...rest }) => (
  <svg
    className="ic"
    width={size}
    height={size}
...
const IconCloud = (p) => <Icon {...p} d="M17.5 19a4.5 4.5 0 0 0 .5-8.97 6 6 0 0 0-11.64-1.6A4 4 0 0 0 6.5 19z" />;
...
Object.assign(window, {
  Icon,
  IconGear, IconPlus, IconX, IconTrash, IconRefresh, IconCloud, IconCheck,
  IconCalendar, IconBell, IconSpinner, IconInbox, IconClock, IconList,
  IconSun, IconMoon, IconLogout, IconChevR, IconChevL, IconChevDown,
  IconGrip, IconResize, IconShield, IconKey, IconLink, IconSliders,
  IconArrowUp, IconFlag, IconNextcloud, IconApple,
});
